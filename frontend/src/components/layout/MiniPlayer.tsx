...
/** Compact persistent player shown on mobile/tablet whenever a
 *  VoiceNote is active. Tap to expand the full player. */
export function MiniPlayer({ onExpand }: MiniPlayerProps) {
  const { current, isPlaying, toggle, elapsed } = usePlayer();
    ...
    <div className="mini-player" aria-hidden={false}>
      ...
      >
        ...
        <span className="mini-player__meta">
          ...
          <span className="mini-player__handle">@{creator.handle}</span>
        </span>
